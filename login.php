 ...
 <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Isi Form Login</h1>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <span id="mybutton" onclick="change()" class="input-group-text">
                                    ...
                                    <svg width="1em" height="2.5em" viewBox="0 0 16 16" class="bi bi-eye-fill" fill="currentColor"
                            ...
                            <div class="col-12">
                            <input type="submit" class="btn btn-primary w-100 py-3" value="Login">
                            </div>
                            <div class="col-12"><a href="index.html" class="btn btn-primary w-100 py-3" type="submit">Batal</a>
                            </div>
                        </div>
                        <br>
                        <div>
                            <label>Belum Berlangganan?</label><a href="form.php"> Klik disini</a>
                        </div>
		</form>
            </div>
        </div>
