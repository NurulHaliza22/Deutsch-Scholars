    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Tambah Jadwal Belajar Peserta</h1>
                <form method="POST" action="proses_tambah_jadwal.php">
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" name="nama" class="form-control" id="nama" placeholder="Nama Peserta" required="required">
                            ...
                            <div class="col-12">
                            <div class="">
                                <select class="form-select" name="keterangan" required="required" id="keterangan">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" name="materi" class="form-control" id="materi" placeholder="Materi" required="required">
                                    <label for="materi">Materi</label>
                                </div>
                            </div>

                            <div class="col-12"><button class="btn btn-primary w-100 py-3" name="submit" type="submit">Tambah Jadwal</a>
                            </div>
                        </div>
                    </form>
            </div>
