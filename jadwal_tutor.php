...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="jadwal_tutor.php" class="nav-item nav-link active">Jadwal</a>
    ...
    <div class="container">            
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="mb-5">Lihat Jadwal Belajar Peserta</h1>
        </div>
        <form action="tambah_jadwal.php" method="post">
            <div class="col-12">
                <button class="btn btn-primary w-100 py-3" name="submit" type="submit">Tambah Jadwal</button>
            </div>
            <br><br><br>
            <div class="row g-4">
                <?php
